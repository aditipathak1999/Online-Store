<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="view_details.aspx.cs" Inherits="user_Default" %>
                                ...
                                <ItemTemplate>
                                         <div class="col-md-7">
									        <div class="desc">
										        <h3><%#Eval("pro_name") %></h3>
										        <p class="price">
											        <span>$<%#Eval("pro_price") %></span><span class="rate text-right"><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-half"></i>(74 Rating)
											        </span>
										        </p>
                                            ...
                                            <div class="input-group">
                                    	        ...
                                    	        <input type="text" id="quantity" name="quantity" class="form-control input-number" value="1" min="1" max="100" disabled>
                                    	        <span class="input-group-btn">
										        ...
										        <p><a href='checkout.aspx?pro_id=<%#Eval("pid") %>' class="btn btn-primary btn-addtocart">Check Out</a></p>
